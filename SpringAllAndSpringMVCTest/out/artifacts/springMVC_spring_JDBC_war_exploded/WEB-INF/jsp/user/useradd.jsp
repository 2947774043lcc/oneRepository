...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/user/useraddsave.html"
             enctype="multipart/form-data" >
				<input type="hidden" name="method" value="add">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div>
                    <label for="userCode">用户编码：</label>
                    <input type="text" name="code" id="userCode" value="">
					<!-- 放置提示信息 -->
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    ...
                    <label for="idPicPath">工作证</label>
                    <input type="file" name="attachs" id="idPicPath"/>
                </div>
                <div>
                    <input type="hidden" id="errorWork_wp" value="${uploadWpError}">
                    <label for="workPicPath">证件照</label>
